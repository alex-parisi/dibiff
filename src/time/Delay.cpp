 ...
 */
std::weak_ptr<dibiff::graph::AudioInput> dibiff::time::Delay::getInput(int i) { return input; }
/**
 * @brief Get the output connection point.
 * @return A shared pointer to the output connection point.
 */
std::weak_ptr<dibiff::graph::AudioOutput> dibiff::time::Delay::getOutput() { return output; }
/**
 * @brief Get the reference connection point.
 * @return Not used.
 */
std::weak_ptr<dibiff::graph::AudioReference> dibiff::time::Delay::getReference() { return std::weak_ptr<dibiff::graph::AudioReference>(); };
/**
