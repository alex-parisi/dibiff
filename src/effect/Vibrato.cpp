 ...
 */
std::weak_ptr<dibiff::graph::AudioInput> dibiff::effect::Vibrato::getInput(int i) { return input; }
/**
 * @brief Get the output connection point.
 * @return A shared pointer to the output connection point.
 */
std::weak_ptr<dibiff::graph::AudioOutput> dibiff::effect::Vibrato::getOutput() { return output; }
/**
 * @brief Get the reference connection point.
 * @return Not used.
 */
std::weak_ptr<dibiff::graph::AudioReference> dibiff::effect::Vibrato::getReference() { return std::weak_ptr<dibiff::graph::AudioReference>(); };
/**
