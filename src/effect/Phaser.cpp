...
void dibiff::effect::Phaser::initialize() {
    ...
    for (int i = 0; i < numStages; ++i) {
        ...
        dibiff::filter::AllPassFilter apf(initialCutoff, sampleRate);
        apf.initialize();
 ...
 */
std::weak_ptr<dibiff::graph::AudioInput> dibiff::effect::Phaser::getInput(int i) { return input; }
/**
 * @brief Get the output connection point.
 * @return A shared pointer to the output connection point.
 */
std::weak_ptr<dibiff::graph::AudioOutput> dibiff::effect::Phaser::getOutput() { return output; }
/**
 * @brief Get the reference connection point.
 * @return Not used.
 */
std::weak_ptr<dibiff::graph::AudioReference> dibiff::effect::Phaser::getReference() { return std::weak_ptr<dibiff::graph::AudioReference>(); };
/**
