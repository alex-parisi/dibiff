 ...
 */
std::weak_ptr<dibiff::graph::AudioOutput> dibiff::effect::Reverb::getOutput() { return output; }
/**
 * @brief Get the reference connection point.
 * @return Not used.
 */
std::weak_ptr<dibiff::graph::AudioReference> dibiff::effect::Reverb::getReference() { return std::weak_ptr<dibiff::graph::AudioReference>(); };
/**
