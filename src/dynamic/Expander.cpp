 ...
 */
std::weak_ptr<dibiff::graph::AudioOutput> dibiff::dynamic::Expander::getOutput() { return output; }
/**
 * @brief Get the reference connection point.
 * @return Not used.
 */
std::weak_ptr<dibiff::graph::AudioReference> dibiff::dynamic::Expander::getReference() { return std::weak_ptr<dibiff::graph::AudioReference>(); };
/**
