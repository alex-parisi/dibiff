 ...
 */
std::weak_ptr<dibiff::graph::AudioInput> dibiff::filter::DigitalBiquadFilter::getInput(int i) { return input; }
/**
 * @brief Get the output connection point.
 * @return A shared pointer to the output connection point.
 */
std::weak_ptr<dibiff::graph::AudioOutput> dibiff::filter::DigitalBiquadFilter::getOutput() { return output; }
/**
 * @brief Get the reference connection point.
 * @return Not used.
 */
std::weak_ptr<dibiff::graph::AudioReference> dibiff::filter::DigitalBiquadFilter::getReference() { return std::weak_ptr<dibiff::graph::AudioReference>(); };
/**
