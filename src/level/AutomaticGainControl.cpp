 ...
 */
std::weak_ptr<dibiff::graph::AudioInput> dibiff::level::AutomaticGainControl::getInput(int i) { return input; }
/**
 * @brief Get the output connection point.
 * @return A shared pointer to the output connection point.
 */
std::weak_ptr<dibiff::graph::AudioOutput> dibiff::level::AutomaticGainControl::getOutput() { return output; }
/**
 * @brief Get the reference connection point.
 * @return Not used.
 */
std::weak_ptr<dibiff::graph::AudioReference> dibiff::level::AutomaticGainControl::getReference() { return std::weak_ptr<dibiff::graph::AudioReference>(); };
/**
